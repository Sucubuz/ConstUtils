package breedableloli.lolihack.gui.screens;

import breedableloli.lolihack.modules.VillagerRoller;
...
public class EnchantmentSelectScreen extends WindowScreen {
    ...
    private void fillTable(WTable table) {
        ...
        for (RegistryEntry<Enchantment> e : available.stream()
                .sorted((o1, o2) -> Names.get(o1).compareToIgnoreCase(Names.get(o2))).toList()) {
